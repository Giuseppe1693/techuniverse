function Footer() {
  return (
    <footer className="bg-[#2C3E50] text-[#BDC3C7] py-8">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm md:text-base">
            ...
            <li>
              <a href="/productList" className="hover:text-[#3498DB] transition">
                Prodotti
              </a>
            </li>
            <li>
              <a href="/cart" className="hover:text-[#3498DB] transition">
                Carrello
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <p className="text-sm md:text-base">
            GitHub:{" "}
            <a href="https://github.com/giuseppe1693" className="hover:text-[#3498DB] transition">
              giuseppe1693
            </a>
          </p>
        </div>
      ...
      <div className="mt-8 border-t border-[#BDC3C7] pt-3 text-center text-sm md:text-base text-[#BDC3C7]">
